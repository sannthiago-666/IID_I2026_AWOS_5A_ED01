        ...
        <Card>
            <CardHeader>
                <CardTitle className="flex items-center gap-2">
                    ...
                    Mostrar dos puntos en el mapa.
                </CardTitle>
                <CardDescription>
                    Muestra un mapa con tu ubicación actual y otro punto definido en los entradas de la página.
                </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        value={latB}
                        onChange={(e) => setLatB(e.target.value)} // ✅ Controlado por React
                        step="0.000001"
                    />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        value={lonB}
                        onChange={(e) => setLonB(e.target.value)} // ✅ Controlado por React
                        step="0.000001"
                    />
                </div>
